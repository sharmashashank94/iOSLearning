...
class MealTableViewController: UITableViewController {
    ...
    func loadSampleMeals() {
        ...
        let meal1 = Meal(name: "Butter Chicken", photo: photo1, rating: 4)!
        
        let photo2 = UIImage(named: "meal2")!
        let meal2 = Meal(name: "Tandoori Naan", photo: photo2, rating: 3)!
        
        let photo3 = UIImage(named: "meal3")!
        let meal3 = Meal(name: "Tandoori Roti", photo: photo3, rating: 5)!
